...
if [ -z $1 ]; then
    ...
    echo "ex: ./BreakingPoint_Azure.bash Ixia_Images_RG bpsvhds900u3"
    exit 1
fi
...
if [ -z $2 ]; then
    ...
    echo "./BreakingPoint_Azure.bash Ixia_Images_RG bpsvhds900u3"
    exit 1
fi
...
#source
source_bps_virtual_controller_blob=Ixia_BreakingPoint_Virtual_Controller_9.00.108_KVM.vhd
source_bps_virtual_blade_blob=Ixia_BreakingPoint_Virtual_Blade_9.00.108_KVM.vhd
source_bps_virtual_controller_account_name=bpsve900u3
source_bps_virtual_controller_container=bps-container
source_bps_virtual_blade_container=bps-container
source_bps_virtual_controller_account_key=uMZ1qSxOy/y6WuWFVJU8sPBTQ5w1Ot+QktedxjCiyXNEr8NN7rdPqbhU/NAmiouxLOK4P0T3OjPvYzEs2aydJw==

#destination
destination_resource_group_name=$1
destination_account_name=$2
destination_container_name=bpsvevhd900u3
destination_bps_virtual_controller_blob=Ixia_BreakingPoint_Virtual_Controller_9.00.108.vhd
destination_bps_virtual_blade_blob=Ixia_BreakingPoint_Virtual_Blade_9.00.108.vhd
